# Ð dashboard
simple dashboard for interacting with the Ð protocol.

forked from [Opyn Monitor](https://opynmonitor.xyz).

## ipfs
for convenience, the current IPFS build of Ð dashboard can be accessed here: [https://emptyset.finance](https://emptyset.finance)
...
- `0x88ff79eB2Bc5850F27315415da8685282C7610F9` **UniswapV2 USDC:DED Pair**
